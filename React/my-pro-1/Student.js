...
export default function Student(){
   return (
        <>
            <table style={{border:"1px solid black",backgroundColor:"yellow"}}>
                
                    {studentData.map((stu) => {
                     return ( <> 
                                <tr>    
                                <td style={{border:"1px solid black",backgroundColor:"pink"}}>{stu.createdAt}</td> 
                                <td style={{border:"1px solid black",backgroundColor:"pink"}}>{stu.name}</td>
                                <td style={{border:"1px solid black",backgroundColor:"pink"}}>
                                    <img src={stu.avatar}/>
                                </td>
                                <td style={{border:"1px solid black",backgroundColor:"pink"}}>{stu.department}</td>
                                <td style={{border:"1px solid black",backgroundColor:"pink"}}>{stu.roll_no}</td>
                                <td style={{border:"1px solid black",backgroundColor:"pink"}}>{stu.city}</td>   
                                <td style={{border:"1px solid black",backgroundColor:"pink"}}>{stu.password}</td>
                                <td style={{border:"1px solid black",backgroundColor:"pink"}}>{stu.username}</td>
                                <td style={{border:"1px solid black",backgroundColor:"pink"}}>{stu.id}</td>
                                </tr>
                            </>
                            )
                        })
