             ...
             <>
                 <table style={{border:"1px solid black"}}>
                         ...
                         {productData.map((pro)=>{
                          return ( <> 
                                    <tr>
                                        <td style={{border:"1px solid black",backgroundColor:"yellow"}}>{pro.createdAt}</td> 
                                        <td style={{border:"1px solid black",backgroundColor:"yellow"}}>{pro.ProductName}</td>
                                        <td style={{border:"1px solid black",backgroundColor:"yellow"}}>
                                             <img src={pro.ProductImage} style={{height:100 , width:100}}/>                                           
                                        </td>
                                        <td style={{border:"1px solid black",backgroundColor:"yellow"}}>{pro.department}</td>
                                        <td style={{border:"1px solid black",backgroundColor:"yellow"}}>{pro.ProductPrice}</td>
                                        <td style={{border:"1px solid black",backgroundColor:"yellow"}}>{pro.ProductDescription}</td>   
                                        <td style={{border:"1px solid black",backgroundColor:"yellow"}}>{pro.id}</td>
                                     </tr>
                                 </>
                                 )
                            })
